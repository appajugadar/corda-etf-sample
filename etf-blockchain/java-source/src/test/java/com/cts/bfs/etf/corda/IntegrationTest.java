...
//        CoreTestUtils.unsetCordappPackages();
//    }
    ...
    public void runDriverTest() {
        ...
        driver(new DriverParameters()
                .setExtraCordappPackagesToScan(Lists.newArrayList("com.cts.bfs.etf.corda.contract"))
                .setIsDebug(true).setStartNodesInProcess(true), dsl -> {
