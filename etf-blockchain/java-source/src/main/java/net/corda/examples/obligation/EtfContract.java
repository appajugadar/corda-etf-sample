...
public class EtfContract implements Contract {
    ...
    private Set<PublicKey> keysFromParticipants(EtfObligation obligation) {
        return obligation
    ...
    private void verifySettle(LedgerTransaction tx, Set<PublicKey> signers) {
        requireThat(req -> {
            ...
            List<EtfObligation> obligationInputs = tx.inputsOfType(EtfObligation.class);
            ...
            EtfObligation inputObligation = obligationInputs.get(0);
            ...
            Amount<Currency> amountOutstanding = null;//inputObligation.getAmount().minus(inputObligation.getPaid()); //TODO
